...
namespace MainGame
{
	void Game::Init()
	{
		...
		AddGameObject<Enemy>(OBJECT)->GetComponent<Transform>()->SetPosition(D3DXVECTOR3(-8.0f, 4.0f, 3.0f));
		...
		AddGameObject<Tree>(OBJECT)->GetComponent<Transform>()->SetPosition(D3DXVECTOR3(-5.0f, 5.0f, 0.0f));
